...
class _RegisterState extends State<Register>
{
  ...
  Future<void> uploadAndSaveImage() async
  {
    ...
    else
    {
      _passwordTextEditingController.text == _cPasswordTextEditingController.text
          ...
          ? uploadToStorage()
          : displayDialog("Please input the feilds")
  ...
  uploadToStorage() async
  {
    ...
    StorageUploadTask storageUplaodTask = storageReference.putFile(_imageFile);

    StorageTaskSnapshot taskSnapshot = await storageUplaodTask.onComplete;
